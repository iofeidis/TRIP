  ...
  navbarPage(
    ...
    tabPanel("Home", value = "home", 
             ...
             sidebarPanel(width = 9,
                          ...
                          withBusyIndicatorUI(actionButton("Continue", "Apply",#icon("paper-plane"), 
    ...
    tabPanel("Preselection", value = "cleaningResults",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.summaryCleaning % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.allDataCleaning % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.cleanTable % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.cleanOut % 2 == 1",
                                        br(),
                                        br(),
    ...
    tabPanel("Selection", value = "filteringResults",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.summary % 2 == 1",
                                        br(),
                                        br(),
                                        uiOutput('tableTitle'),
                                        tableOutput('table')),
                       ...
                       conditionalPanel(condition = "input.allData % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.filterIn % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.filterOut % 2 == 1",
                                        br(),
                                        br(),
    ...
    tabPanel("Pipeline", value = "pipeline",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.pipeline_clonotypes % 2 == 1",
                                        ...
                                        selectInput("select_clonotype", "Select type:", c("V Gene + CDR3 Amino Acids",
                                        ...
                                        checkboxInput("diagnosis", c("Diagnosis",
                                                                      list(tags$style(type = "text/css", "#q_clonotypes {vertical-align: top;}"),
                                                                           bsButton("q_diagnosis", label = "", icon = icon("question"), size = "extra-small"))),
                                                      width="500px"),
                                        
                                        bsPopover(id = "q_diagnosis", title = "Diagnosis",
                       ...
                       conditionalPanel(condition = "input.pipeline_highly_similar_clonotypes % 2 == 1",
                                        #br(),
                       ...
                       conditionalPanel(condition = "output.num_of_datasets>1 | input.select_load_or_compute_clonotypes == 'load_clonotypes'",
                                        ...
                                        conditionalPanel(condition = "input.pipeline_public_clonotypes % 2 == 1",
                                                         ...
                                                         conditionalPanel(condition = "input.select_topN_or_reads_thr_shared_clono == 'select_reads_thr_shared_clono'",
                                                                          numericInput("thr_public_clono_reads", "Threshold for Clonotype reads:", 1,  
                                                                                       min = 0, max = 100000000, width="140px")),
                                                         
                                                         conditionalPanel(condition = "input.select_topN_or_reads_thr_shared_clono == 'select_topN_thr_shared_clono'",
                                                                          numericInput("thr_public_clono_topN", "Threshold using clonotype rank:", 100,  
                                                                                       min = 0, max = 1000000000000, width="140px")),
                       ...
                       conditionalPanel(condition = "output.num_of_datasets>1 | input.select_load_or_compute_clonotypes == 'load_clonotypes'",
                                        ...
                                        conditionalPanel(condition = "input.pipeline_highly_sim_public_clonotypes % 2 == 1",
                                                         selectInput("take_gene_highly_sim_public_clono", "Take Gene into account:",c("No","Yes"), width="320"),
                                                         numericInput("thr_highly_sim_public_clono", "Threshold for Clonotype reads:", 1,  
                                                                      min = 0, max = 100000000, width="140px"),
                       ...
                       conditionalPanel(condition = "input.pipeline_Repertoires % 2 == 1",
                       ...
                       conditionalPanel(condition = "input.cell == 'B cell'",
                                        ...
                                        conditionalPanel(condition = "input.pipeline_insert_identity_groups % 2 == 1",
                       ...
                       conditionalPanel(condition = "input.cell == 'B cell'",
                                        ...
                                        conditionalPanel(condition = "input.pipeline_mutational_status % 2 == 1 & input.pipeline_highly_similar_clonotypes % 2 == 1",
                       ...
                       conditionalPanel(condition = "input.pipeline_cdr3_distribution % 2 == 1 & input.pipeline_highly_similar_clonotypes % 2 == 1",
                       ...
                       conditionalPanel(condition = "input.pipeline_pi_distribution % 2 == 1 & input.pipeline_highly_similar_clonotypes % 2 == 1",
                       ...
                       conditionalPanel(condition = "input.pipeline_Multiple_value_comparison % 2 == 1 & input.pipeline_highly_similar_clonotypes % 2 == 1",
                                        radioButtons("select_clono_or_highly_for_Multiple_value_comparison", "Use:",
                                                     c("Initial clonotypes" = "initial_clonotypes",
                                                       "Highly similar clonotypes" = "highly_similar_clonotypes")),
                                        br()),
                       
                       conditionalPanel(condition = "input.pipeline_Multiple_value_comparison % 2 == 1 ",
                       ...
                       conditionalPanel(condition = "input.pipeline_CDR3Diff1 % 2 == 1",
                       ...
                       conditionalPanel(condition = "input.cell == 'B cell'",
                                        ...
                                        conditionalPanel(condition = "input.pipeline_alignment % 2 == 1",
                                                         ...
                                                         conditionalPanel(condition = "input.useGermline  == 'Insert Germline'",
                                                         ...
                                                         conditionalPanel(condition = "input.select_topN_clonotypes_for_alignment == 'topN_clonotypes_for_alignment'",
                                                                          numericInput("topNClonoAlignment", "Select N", 20,  
                                                                                       min = 1, max = 10000000000000, width="140px")),
                                                         
                                                         conditionalPanel(condition = "input.select_topN_clonotypes_for_alignment == 'thr_clonotypes_for_alignment'",
                                                                          numericInput("thrClonoAlignment", "Select Threshold %. Range[0,100]", 0.1,  
                                                                                       min = 1, max = 100, width="140px"))),
                       ...
                       conditionalPanel(condition = "input.cell == 'B cell'",
                                        ...
                                        conditionalPanel(condition = "input.pipeline_mutations % 2 == 1",
                                                         selectInput("AAorNtMutations", "AA or Nt:",c("aa","nt","both"), width="170px"),
                                                         # numericInput("MaxLengthRegion", "Max length of region:", 127,  min = 0, max = 150, width="140px"),
                                                         
                                                         conditionalPanel(condition = "input.AAorNtMutations  == 'aa' | input.AAorNtMutations  == 'both'",
                                                                          numericInput("ThrAAMutations", "Select threshold for AA: range [0,1]", 0.5,  
                                                                                       min = 0, max = 1, width="140px")),
                                                         
                                                         conditionalPanel(condition = "input.AAorNtMutations  == 'nt' | input.AAorNtMutations  == 'both'",
                                                                          numericInput("ThrNtMutations", "Select threshold for Nt range [0,1]:", 0.5,  
                                                                                       min = 0, max = 1, width="140px")),
                                                         ...
                                                         conditionalPanel(condition = "input.select_topN_clonotypes_for_mutations == 'topN_clonotypes_for_mutations'",
                                                                          numericInput("topNClonoMutations", "Select N", 20,  
                                                                                       min = 1, max = 10000000000000, width="140px")),
                                                         
                                                         conditionalPanel(condition = "input.select_topN_clonotypes_for_mutations == 'thr_clonotypes_for_mutations'",
                                                                          numericInput("thrClonoMutations", "Select Threshold %. Range[0,100]", 0.1,  
                                                                                       min = 1, max = 100, width="140px")),
                                                         
                                                         checkboxInput("select_clonotypes_for_mutations", "Select clonotypes separately", width="500px"),
                                                         
                                                         conditionalPanel(condition = "input.select_clonotypes_for_mutations  % 2 == 1",
                                                                          textInput("clonotypes_for_mutations", "cluster ids"),
                                                                          helpText("Separate the different cluster ids with comma e.g. 1,2,4")),
                                                         br()),
                                        
                                        uiOutput("confirmMutations")), # uiOutput("confirmGroupedAlignment")
                       ...
                       conditionalPanel(condition = "input.pipeline_logo % 2 == 1",
                                        tags$div(id = 'placeholder'),
                                        ...
                                        conditionalPanel(condition = "input.select_topN_clonotypes_for_freqTable == 'topN_clonotypes_for_logos'",
                                                         numericInput("topNClonoLogos", "Select N", 20,  min = 1, max = 10000000000000, width="140px")),
                                        
                                        conditionalPanel(condition = "input.select_topN_clonotypes_for_freqTable == 'thr_clonotypes_for_logos'",
                                                         numericInput("thrClonoLogos", "Select Threshold %. Range[0,100]", 0.1,  
                                                                      min = 1, max = 100, width="140px")),
                                        
                                        checkboxInput("select_clonotypes_for_logo", "Select clonotypes separately", width="500px"),
                                        
                                        conditionalPanel(condition = "input.select_clonotypes_for_logo  % 2 == 1",
                       ...
                       #### Execute pipeline 2nd part ####
                       
                       conditionalPanel(condition = "input.Execute_pipeline % 2 == 1",
                                        withBusyIndicatorUI(actionButton("Execute_pipeline_2nd_part", "Execute pipeline 2nd part", #icon("paper-plane"),
                                                                         style="color: #fff; background-color: #5F021F; border-color: #fff; hover: #B2577A")))
                       )),
    ...
    tabPanel("Clonotypes", value = "Clonotypes",
             mainPanel(br(), br(), br(), br(),
                       ...
                       br(),
                       actionButton("clonotypes", "View Clonotypes", style="color: #fff; background-color: #5F021F; border-color: #fff"),
                       
                       
                       conditionalPanel(condition = "input.shm_normal % 2 == 1",
                                        actionButton("shm_normal_clonotypes", "View SHM Normal", 
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff")),
                       
                       conditionalPanel(condition = "input.diagnosis % 2 == 1",
                                        actionButton("view_diagnosis", "View Diagnosis results", 
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff")),
                       
                       conditionalPanel(condition = "input.clonotypes % 2 == 1",
                                        br(),
                                        br(),
                                        # uiOutput('clonoTitle'),
                                        ...
                                        # The pop-up window
                                        bsModal("modalViewSpecificClonotype", "Elements of the clonotype", "NA",
                                                size = "large",
                                                dataTableOutput('viewSpecificClonotype'),
                                                downloadButton('downloadElementsOfClonotype', 'Download')),
                                         
                                        # The pop-up window
                                        bsModal("modalViewConvergentEvolution", "Elements of convergent evolution", "NA",
                                                size = "large",
                                                dataTableOutput('viewSpecificConvergentEvolution'),
                                                downloadButton('downloadConvergentEvolution', 'Download')),
                                         
                                        downloadButton("downloadAllClonotypes", "Download")),
                       
                       conditionalPanel(condition = "input.shm_normal_clonotypes % 2 == 1",
                                        br(),
                                        br(),
                                        # uiOutput('clonoTitle'),
                       ...
                       conditionalPanel(condition = "input.view_diagnosis % 2 == 1",
                                        br(),
                                        br(),
                                        # uiOutput('clonoTitle'),
                       ...
                       conditionalPanel(condition = "input.pipeline_public_clonotypes == 1",
                                        br(),
                                        br(),
                                        actionButton("public_clonotypesBtn", "View Public Clonotypes", 
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                        
                                        conditionalPanel(condition = "input.public_clonotypesBtn % 2 == 1",
                                        br(),
                                        br(),
    ...
    tabPanel("Highly Similar Clonotypes", value = "highly_similar_clonotypes",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.highly_similar_all_clonotypes_btn % 2 == 1",
                                        br(),
                                        br(),
                                        # uiOutput('clonoTitle'),
                       ...
                       conditionalPanel(condition = "input.highly_similar_clonotypes_btn % 2 == 1",
                                        br(),
                                        br(),
                                        # uiOutput('clonoTitle'),
                                        ...
                                        br(),
                                        downloadButton('downloadAllhighlySimClonotypes_allGroups')), # plotOutput("clonotypes_bar_plot")
                       
                       conditionalPanel(condition = "input.high_shm_normal % 2 == 1",
                                        br(),
                                        actionButton("high_SHM_similarity_btn", "View high SHM similarity",
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                        
                                        conditionalPanel(condition = "input.high_SHM_similarity_btn % 2 == 1",
                                                         br(),
                                                         dataTableOutput('highSHMsimilarity_table'),
                                                         br(),
                                                         downloadButton("downloadHighSHMsimilarity", "Download"))),
               
                       br(),
                       br(),
                       br(),

                       conditionalPanel(condition = "input.pipeline_highly_sim_public_clonotypes == 1",
                                        br(),
                                        br(),
                                        actionButton("highly_sim_public_clonotypesBtn", "View Highly Similar Public Clonotypes",
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                        
                                        conditionalPanel(condition = "input.highly_sim_public_clonotypesBtn % 2 == 1",
                                                         br(),
                                                         br(),
    ...
    tabPanel("Repertoires", value = "Repertoires",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.RepertoiresBtn % 2 == 1",
                                        br(),
                                        br(),
             ...
             mainPanel(br(),
                       conditionalPanel(condition = "input.pipeline_HighlySim_Repertoires == 1",
                       actionButton("HighlySim_RepertoiresBtn", "View Highly Similar Repertoires",
                                    style="color: #fff; background-color: #5F021F; border-color: #fff"),

                       conditionalPanel(condition = "input.HighlySim_RepertoiresBtn % 2 == 1",
                                        br(),
                                        br(),
             ...
             mainPanel(br(),
                       conditionalPanel(condition = "input.pipeline_repertoires_comparison == 1",
                                        br(),
                                        br(),
                                        actionButton("repertoires_comparisonBtn", "View Repertoires comparison",
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                        
                                        conditionalPanel(condition = "input.repertoires_comparisonBtn % 2 == 1",
                                                         br(),
                                                         br(),
             ...
             mainPanel(br(),
                       ...
                       conditionalPanel(condition = "input.Highly_sim_repertoires_comparisonBtn % 2 == 1",
                                        br(),
                                        br(),
    ...
    tabPanel("Multiple value comparison", value = "Multiple_value_comparisonTab",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.Multiple_value_comparisonBtn % 2 == 1",
                                        br(),
                                        br(),
                                        uiOutput('uiMultiple_value_comparisonTables')), # downloadButton("downloadMultiple_value_comparison", "Download")
    ...
    tabPanel("CDR3 1 Length Diff", value = "CDR3_with_1_length_difference_tab",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.CDR3Diff1Button % 2 == 1",
                                        br(),
                                        br(),
    ...
    tabPanel("Alignment", value = "Alignment",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.alignmentButton % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.groupedAlignmentButton % 2 == 1 ",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.AAorNtAlignment == 'both'",
                                        actionButton("alignmentButtonNt", "View Alignment nt",
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                        
                                        conditionalPanel(condition = "input.alignmentButtonNt % 2 == 1",
                                                         br(),
                                                         br(),
                                        ...
                                        conditionalPanel(condition = "input.groupedAlignmentButtonNt % 2 == 1 ",
                                                         br(),
                                                         br(),
    ...
    tabPanel("Somatic hypermutations", value = "Mutation_tab",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.MutationButton % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.AAorNtMutations == 'both'",
                                        actionButton("MutationButtonNt", "View Mutation nt",
                                                     style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                        
                                        conditionalPanel(condition = "input.MutationButtonNt % 2 == 1",
                                                         br(),
                                                         br(),
                       ...
                       conditionalPanel(condition = "input.select_clonotypes_for_mutations % 2 == 1",
                                        ...
                                        conditionalPanel(condition = "input.ViewMutationsPerCluster % 2 == 1",
                                                         br(),
                                                         br(),
    ...
    tabPanel("Logo", value = "logo_tab",
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.countTable % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.freqTable % 2 == 1",
                                        br(),
                                        br(),
                       ...
                       conditionalPanel(condition = "input.select_clonotypes_for_logo % 2 == 1",
                                        ...
                                        conditionalPanel(condition = "input.countFreqTableSep % 2 == 1",
                                                         br(),
                                                         br(),
             ...
             mainPanel(br(), br(), br(), br(),
                       ...
                       conditionalPanel(condition = "input.logoButton % 2 == 1",
                                        conditionalPanel(condition = "input.regionFreqTable != 'CDR3'",
                                                         br(),
                       ...
                       conditionalPanel(condition = "input.select_clonotypes_for_logo % 2 == 1",
                                        ...
                                        conditionalPanel(condition = "input.LogosSep % 2 == 1",
                                                         br(),
                                                         br(),
                                                         uiOutput("uiLogos_cl")),
    ...
    tabPanel("Visualisation", value = "Visualisation",
             mainPanel(br(), br(), br(), br(),
               ...
               conditionalPanel(condition = "input.pipeline_clonotypes == 1",
                                ...
                                conditionalPanel(condition = "input.view_clonotype_bar % 2 == 1",
                                                 br(),
                                                 br(),
                                                 ...
                                                 conditionalPanel(condition = "input.clonotypes_barplot_select_range % 2 == 1",
               ...
               conditionalPanel(condition = "input.pipeline_highly_similar_clonotypes == 1",
                                # plotOutput("clonotypes_bar_plot_visualisation"),
                                ...
                                conditionalPanel(condition = "input.view_higly_sim_clonotype_bar % 2 == 1",
                                                 br(),
                                                 br(),
                                                 ...
                                                 conditionalPanel(condition = "input.higly_sim_clonotypes_barplot_select_range % 2 == 1",
               ...
               conditionalPanel(condition = "input.pipeline_Repertoires == 1",
                                actionButton("view_repertoire_pies", "View Repertoire pies",
                                             style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                
                                br(),
                                conditionalPanel(condition = "input.view_repertoire_pies % 2 == 1",
                                                 br(),
                                                 uiOutput("RepertoiresPiesUi")),
                                br()),
               
               conditionalPanel(condition = "input.pipeline_Repertoires == 1 & input.pipeline_HighlySim_Repertoires == 1",
                                actionButton("view_highly_sim_repertoire_pies", "View Highly Similar Repertoire pies",
                                             style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                
                                br(),
                                
                                conditionalPanel(condition = "input.view_highly_sim_repertoire_pies % 2 == 1",
                                                 br(),
               ...
               conditionalPanel(condition = "input.pipeline_mutational_status == 1",
                                actionButton("view_mutational_status", "View Somatic hypermutation status plots",
                                             style="color: #fff; background-color: #5F021F; border-color: #fff"),
                                
                                conditionalPanel(condition = "input.view_mutational_status % 2 == 1",
                                                 br(),
                                                 ...
                                                 conditionalPanel(condition = "input.view_mutational_status_table % 2 == 1",
                                                                  br(),
                                                                  tableOutput("mutational_status_table"))),
                                br(),
                                br()),

               conditionalPanel(condition = "input.pipeline_logo == 1",
                                actionButton("view_logo_plots", "View Logo plots",
                                             style="color: #fff; background-color: #5F021F; border-color: #fff"),
                
                                br(),
                
                                conditionalPanel(condition = "input.view_logo_plots % 2 == 1",
                                                 plotOutput('logo_visualisation')),
                                
                                br()),
               
               conditionalPanel(condition = "input.pipeline_clonotypes == 1 && output.num_of_datasets>1",
                                ...
                                conditionalPanel(condition = "input.nucleotides_per_clonotype % 2 == 1",
                                                 br(),
                                                 ...
                                                 conditionalPanel(condition = "input.select_plot_type_nucleotides_per_clonotype == 'hist3D'",
                                                                  plotOutput("nucleotides_per_clonotype_hist3D"),
                                                                  br()),
                              
                                                 conditionalPanel(condition = "input.select_plot_type_nucleotides_per_clonotype == 'persp3D'",
                                                                  plotOutput("nucleotides_per_clonotype_persp3D"),
                                                                  br()),
                              
                                                 conditionalPanel(condition = "input.select_plot_type_nucleotides_per_clonotype == 'image2D'",
                                                                  plotOutput("nucleotides_per_clonotype_image2D"),
                                                                  br()),
                              
                                                 conditionalPanel(condition = "input.select_plot_type_nucleotides_per_clonotype == 'surface'",
               ...
               conditionalPanel(condition = "input.pipeline_cdr3_distribution == 1",
                                actionButton("view_length_distribution", "View CDR3 length Distribution",
                                             style="color: #fff; background-color: #5F021F; border-color: #fff"),
                
                                br(),
                
                                conditionalPanel(condition = "input.view_length_distribution % 2 == 1",
                                                 br(),
                                                 ...
                                                 conditionalPanel(condition = "input.view_length_distribution_table % 2 == 1",
                                                                  br(),
                                                                  dataTableOutput("length_distribution_table")))),
               
               br(),

               conditionalPanel(condition = "input.pipeline_pi_distribution == 1",
                 actionButton("view_pI_distribution", "View pI Distribution",
                              style="color: #fff; background-color: #5F021F; border-color: #fff"),

                 br(),

                 conditionalPanel(condition = "input.view_pI_distribution % 2 == 1",
                                  br(),
                                  ...
                                  conditionalPanel(condition = "input.view_pI_distribution_table % 2 == 1",
                                                   br(),
